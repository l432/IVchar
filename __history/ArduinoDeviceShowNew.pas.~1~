...
constructor TArduinoSetterShowNew.Create(ArdSet: TArduinoSetterNew;
                                     PinLs: array of TPanel;
                                     PinVariant:TStringList);
begin
 inherited Create();
...
procedure TArduinoSetterShowNew.CreatePinShow(PinLs: array of TPanel;
                                        PinVariant:TStringList);
begin
 PinShow:=TPinsShowUniversal.Create(fArduinoSetter.Pins,PinLs,[PinVariant]);
end;

procedure TArduinoSetterShowNew.Free;
begin
 PinShow.Free;
 inherited Free;
end;

procedure TArduinoSetterShowNew.HookReadFromIniFile(ConfigFile: TIniFile);
begin
 PinShow.ReadFromIniFile(ConfigFile);
end;

procedure TArduinoSetterShowNew.ReadFromIniFile(ConfigFile: TIniFile);
begin
...
procedure TArduinoSetterShowNew.WriteToIniFile(ConfigFile: TIniFile);
begin
