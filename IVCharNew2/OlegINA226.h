...
const uint8_t  INA_CONVERSION_READY_MASK    = 0x80;                         // Bit 4                            //
const uint16_t INA_CONFIG_MODE_MASK         = 0x0007;                       // Bits 0-3                         //
const uint16_t INA_TO_SLEEP_MODE_MASK       = 0xFFF8;                       // Bits 0-3 in 0                    //
...
const uint16_t INA226_averages[] = {1, 4, 16, 64, 128, 256, 512, 1024};
const uint16_t INA226_ConvTime[] = {140, 204, 332, 588, 1100, 2116, 4156, 8244};
